...
export function Hero() {
  return (
    <section id="home" className="relative flex h-screen max-h-screen flex-col justify-center overflow-hidden">
      ...
      <div className="mx-auto grid w-full max-w-7xl grid-cols-1 items-center gap-16 px-6 lg:grid-cols-2 lg:px-10">
        ...
        >
          ...
          <img
            ...
            className="relative z-10 h-[540px] w-auto max-w-full object-contain drop-shadow-[0_30px_40px_rgba(0,0,0,0.5)]"
          />
        </motion.div>
      </div>
    </section>
